...
public class RightOuterJoin implements JoinStrategy {
    ...
    public TransitDataBundle execute(ConnectionManager firstConnection, String firstTable, ConnectionManager secondConnection, String secondTable) {
        ...
        String query = "SELECT * FROM " + firstTable + " RIGHT OUTER JOIN " + secondTable + " ON " + firstTable + ".id = " + secondTable + ".id"; // Adjust the join condition
