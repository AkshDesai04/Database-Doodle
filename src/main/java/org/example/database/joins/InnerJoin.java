...
public class InnerJoin implements JoinStrategy {
    ...
    public TransitDataBundle execute(ConnectionManager firstConnection, String firstTable, ConnectionManager secondConnection, String secondTable) {
        ...
        String query = "SELECT * FROM " + firstTable + " INNER JOIN " + secondTable + " ON " + firstTable + ".id = " + secondTable + ".id"; // Adjust the join condition
